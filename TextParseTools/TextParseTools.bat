...
cd /d "%~dp0"
REM debug±äÁ¿Èç¹ûÎª0µÄ»°ÔÚÓöµ½´íÎóÊ±»áÔÝÍ£
set debug=0
title ÎÄ±¾½âÎö¹¤¾ß¿â F_Ms 20151125
...
REM call:ChooseOneLine "ÎÄ¼þ" ¿ªÊ¼ÐÐ ¼¸ÐÐ [±äÁ¿ | /f "ÎÄ¼þ"](¶àÐÐÄÚÈÝ±ØÐëÐ´Èëµ½ÎÄ¼þ)
:´ÓÒ»¸öÎÄ¼þÖÐÖ¸¶¨Ä³Ò»ÐÐ.½«ÐÐÄÚÈÝ¸³Öµµ½±äÁ¿»òÐ´Èëµ½ÎÄ¼þ
:ChooseOneLine
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~4"=="" (
		call:ShowErrorMessage [²ÎÊý4]ÐÐÄÚÈÝÁô´æ·½·¨Ñ¡Ôñ
		exit/b 1
	)
	if /i "%~4"=="/f" if "%~5"=="" (
		call:ShowErrorMessage [²ÎÊý5]%~5,Ö¸¶¨ÐÐÄÚÈÝÐ´ÈëÎÄ¼þÂ·¾¶Îª¿Õ
		exit/b 1
	) else if exist "%~5" (
		call:ShowErrorMessage [²ÎÊý5]%~5,Ö¸¶¨ÐÐÄÚÈÝÐ´ÈëÎÄ¼þÒÑ´æÔÚ
		exit/b 1
	)
	if "%~3"=="" (
		call:ShowErrorMessage [²ÎÊý]Ö¸¶¨¼¸ÐÐÎª¿Õ
		exit/b 1
	) else if %~3 lss 1 (
		call:ShowErrorMessage [²ÎÊý3]%~3,Ö¸¶¨¼¸ÐÐÖµÐ¡ÓÚ1
		exit/b 1
	)
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]¿ªÊ¼ÐÐÎª¿Õ
		exit/b 1
	) else if %~3 gtr 1 if /i not "%~4"=="/f" (
		call:ShowErrorMessage [²ÎÊý2]%~3,µ±ÌáÈ¡ÐÐÊý¶àÓÚÒ»ÐÐÊ±Ö»ÄÜ½«ÐÐÄÚÈÝ´æ´¢µ½ÎÄ¼þ
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]Ö¸¶¨³éÈ¡ÐÐÔ´ÎÄ¼þÎª¿Õ
		exit/b 1
	) else if not exist "%~1" (
		call:ShowErrorMessage [²ÎÊý1]%~1,Ö¸¶¨³éÈ¡ÐÐÔ´ÎÄ¼þ²»´æÔÚ
		exit/b 1
	)
...
REM call:ReplaceVariableContent ±äÁ¿Ãû Ìæ»»ÄÚÈÝ ±»Ìæ»»ÄÚÈÝ Ìæ»»ÄÚÈÝ2 ±»Ìæ»»ÄÚÈÝ2 ... ...
:Ìæ»»±äÁ¿ÄÚÈÝ
:ReplaceVariableContent
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]Ìæ»»ÄÚÈÝÎª¿Õ
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]±äÁ¿ÃûÎª¿Õ
		exit/b 1
	) else  if not defined %1 (
		call:ShowErrorMessage [²ÎÊý1]%1±äÁ¿²»´æÔÚ
		exit/b 1
	)
	REM ×Ó³ÌÐòÔË×÷¿ªÊ¼
	set %1="!%1:%~2=%~3!"
...
REM call:ChooseFromVariable Ô´±äÁ¿Ãû ÒÔ¿Õ¸ñ·Ö¸ôµÚÄ³¸öÖµ ½á¹û±»¸³Öµ±äÁ¿ [/nocheck](²»½øÐÐ¼ì²éÖµÊÇ·ñ´æÔÚ)
:´Ó±äÁ¿ÖÐÑ°ÕÒÒÔ¿Õ¸ñ·Ö¸ôµÄµÚÄ³¼¸¸öÖµ
:ChooseFromVariable
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~3"=="" (
		call:ShowErrorMessage [²ÎÊý3]½á¹û±»¸³Öµ±äÁ¿Îª¿Õ
		exit/b 1
	)
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]µÚÄ³¸öÖµÖ¸¶¨Îª¿Õ
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]%~1±äÁ¿ÃûÎª¿Õ
		exit/b 1
	) else if not defined %~1 (
		call:ShowErrorMessage [²ÎÊý1]±äÁ¿Î´±»¸³Öµ
		exit/b 1
	)
	...
	call:Count 0 !%~1!
	if %~2 gtr %errorlevel% (
		call:ShowErrorMessage [ÆäËü]%~2Ö¸¶¨Öµ²»´æÔÚ
	)
	:ChooseFromVariable2
...
REM call:EraseSpace "ÎÄ¼þ1" "ÎÄ¼þ2" ...
:È¥³ýÎÄ¼þÖÐËõ½øÓë¿Õ°×¿ÕÐÐ
:EraseSpace
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	for %%x in (subroutine) do if defined %%x set %%x=
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]ÎÄ¼þÖ¸¶¨Îª¿Õ
		exit/b 1
	) else if not exist "%~1" (
		call:ShowErrorMessage [²ÎÊý1]%~1ÎÄ¼þ²»´æÔÚ
		exit/b 1
	)
...
REM call:GetKeyWordLineNumberInFile "ÎÄ¼þ" [/i(²»Çø·Ö´óÐ¡Ð´)] [/t(Ö»ËÑË÷Î»ÓÚÐÐÊ×µÄ)] "¹Ø¼ü×Ö" "³öÏÖ¶à¸öÑ¡È¡µÚ¼¸¸ö" "Ê¹½á¹ûÆ«ÒÆÖµ"
:¸ù¾Ý¹Ø¼ü×Ö´ÓÎÄ¼þ²éÕÒËùÔÚÐÐ·µ»ØÐÐºÅ
:GetKeyWordLineNumberInFile
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]¹Ø¼ü×ÖÎª¿Õ
		exit/b 1
	) else (
		if /i "%~2"=="/i" (
	...
	if not "%~3"=="" (
		...
		if "!errorlevel!"=="0" (
			call:ShowErrorMessage [²ÎÊý3]%~3Ö¸¶¨Ñ¡È¡µÚ¼¸¸öÊýÖµÐ¡ÓÚ1
			exit/b 1
		)
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]ÊäÈëÎÄ¼þÎª¿Õ
		exit/b 1
	) else if not exist "%~1" (
		call:ShowErrorMessage [²ÎÊý1]%~1ÊäÈëÎÄ¼þ²»´æÔÚ
		exit/b 1
	)
	...
	if not "%errorlevel%"=="0" (
		call:ShowErrorMessage [ÆäËü]Î´ÄÜ´ÓÎÄ¼þ"%~1"ÖÐÕÒµ½"%~2"
		exit/b 0
	)
call:ShowErrorMessage [½á¹û]¸ù¾ÝÑ¡È¡¶àÏîÖÐµÚ%~3¸öÎ´ÄÜÕÒµ½½á¹û,»òÎ´ÄÜ´ÓÎÄ¼þ"%~1"ÖÐÕÒµ½"%~2"
exit/b 0

REM ÏÔÊ¾´íÎó
REM call:ShowErrorMessage ´íÎóÄÚÈÝ
:ShowErrorMessage
if defined subroutine echo=	#³öÏÖ´íÎó,×Ó³ÌÐò:%subroutine%,ÃèÊö£º%*
if not defined subroutine echo=	#³öÏÖ´íÎó,ÃèÊö£º%*
if "%debug%"=="0" pause
goto :eof

REM call:CompareSize ±È½ÏÊý ±È½Ï±í´ïÊ½(ÓëifÖÐÏàÍ¬) ±»±È½ÏÊý
:±È½Ï´óÐ¡
:CompareSize
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~3"=="" (
		call:ShowErrorMessage [²ÎÊý3]ÎÞ±»±È½ÏÊý
		exit/b 1
	)
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]ÎÞ±È½Ï±í´ïÊ½
		exit/b 1
	) else if /i not "%~2"=="equ" if /i not "%~2"=="neq" if /i not "%~2"=="lss" if /i not "%~2"=="leq" if /i not "%~2"=="gtr" if /i not "%~2"=="geq" (
		call:ShowErrorMessage [²ÎÊý2]%~2±í´ïÊ½´íÎó
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]ÎÞ±È½ÏÊý
		exit/b 1
	)
...
REM call:Convert2OK_Name ´ý×ª»»±äÁ¿Ãû1 [´ý×ª»»±äÁ¿Ãû2] [´ý×ª»»±äÁ¿Ãû3] ...
:½«º¬ÓÐÎÄ¼þÃûµÄ±äÁ¿×ª»»ÎªºÏ¹æµÄÎÄ¼þÃû
:Convert2OK_Name
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	:Convert2OK_Name2
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]´ý×ª»»±äÁ¿Îª¿Õ
		exit/b 1
	)
	if not defined %~1 (
		call:ShowErrorMessage [²ÎÊý1]%~1:´ý×ª»»±äÁ¿Î´±»¸³Öµ
		exit/b 1
	)
	
	REM ×Ó³ÌÐòÔË×÷¿ªÊ¼
	if not "!%~1!"=="!%~1::=!" set %~1=!%~1::=£º!
	if not "!%~1!"=="!%~1:?=!" set %~1=!%~1:?=£¿!
	if not "!%~1!"=="!%~1:/=!" set %~1=!%~1:/= !
	if not "!%~1!"=="!%~1:\=!" set %~1=!%~1:\= !
	if not "!%~1!"=="!%~1:/*!" set %~1=!%~1:/*=!
...
REM call:LitterConvert [ aA | Aa ] Òª×ª»»µÄ±äÁ¿
:×ÖÄ¸´óÐ¡Ð´×ª»»
:LitterConvert
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	for %%z in (subroutine) do if defined %%v set %%v=
	...
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]×ª»»²ÎÊýÎ´ÌîÐ´:aA^(×ª»»Îª´óÐ´^)»òAa^(×ª»»ÎªÐ¡Ð´^)
		exit/b 1
	) else if not "%~1"=="aA" if not "%~1"=="Aa" (
		call:ShowErrorMessage [²ÎÊý1]%~1²ÎÊý´íÎó£¬ÇëÊäÈëaA^(×ª»»Îª´óÐ´^)»òAa^(×ª»»ÎªÐ¡Ð´^)
		exit/b 1
	)
	:LitterConvert2
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]ÊäÈë±äÁ¿Îª¿Õ
		exit/b 1
	) else if not defined %~2 (
		call:ShowErrorMessage [²ÎÊý2]%~2ÊäÈë±äÁ¿Î´±»¸³Öµ
		exit/b 1
	)
...
REM call:FindKeywordsCountInFile ÎÄ¼þ ¹Ø¼ü×Ö [Æ«ÒÆÖµ]
:´ÓÎÄ¼þÖÐ²éÕÒº¬ÓÐÖ¸¶¨¹Ø¼ü×ÖµÄÐÐµÄÊýÁ¿
:FindKeywordsCountInFile
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]²éÕÒ¼ÆÊý¹Ø¼ü×ÖÎ´ÌîÐ´
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]Ö¸¶¨ÎÄ¼þÎª¿Õ
		exit/b 1
	) else if not exist "%~1" (
		call:ShowErrorMessage [²ÎÊý1]"%~1"Ö¸¶¨ÎÄ¼þ²»´æÔÚ
		exit/b 1
	)
...
REM call:Count Æ«ÒÆÖµ µÚÒ» µÚ¶þ µÚÈý ..
:¼ÆÊý
:Count
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]¼ÆÊýÖµÎª¿Õ
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]Æ«ÒÆÖµÎª¿Õ
	)
...
REM call:Content2Variable »ù±¾Ãû ×ÜÊýÁ¿ ¸³ÖµÄÚÈÝ1 ¸³ÖµÄÚÈÝ2 ¸³ÖµÄÚÈÝ3 ...
:ÄÚÈÝ¸³Öµµ½±äÁ¿
:Content2Variable
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~4"=="" (
		call:ShowErrorMessage [²ÎÊý3,*]¸³ÖµÄÚÈÝÎª¿Õ
		exit/b 1
	)
	if "%~3"=="" (
		call:ShowErrorMessage [²ÎÊý2]×ÜÊýÁ¿Îª¿Õ
		exit/b 1
	)
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]»ù±¾±äÁ¿ÃûÎª¿Õ
		exit/b 1
	)
	...
	if not "%~2"=="%errorlevel%" (
		call:ShowErrorMessage [ÆäËü]×ÜÊýÁ¿Óë¸³ÖµÄÚÈÝÊýÁ¿²»Í¬
		exit/b 1
	)
	for /l %%V in (1,1,%~2) do (
...
REM call:UnicodeConvert ±»×îÖÕ¸³Öµ±äÁ¿Ãû ×ª»»Öµ1 ×ª»»Öµ2 ×ª»»Öµ3 ...
:Unicode×ª»»
:UnicodeConvert
	REM ³õÊ¼»¯×Ó³ÌÐòÐèÇó±äÁ¿
	...
	REM ¼ì²é×Ó³ÌÐòÊ¹ÓÃ»ù±¾¹æÔòÕýÈ·Óë·ñ
	if "%~1"=="" (
		call:ShowErrorMessage [²ÎÊý1]×îÖÕ¸³Öµ±äÁ¿ÃûÎª¿Õ
		exit/b 1
	)
	:UnicodeConvert2
	if exist "%UnicodeTMPFile%" del /f /q "%UnicodeTMPFile%"
	if "%~2"=="" (
		call:ShowErrorMessage [²ÎÊý2]±»×ª»»ÖµÎª¿Õ
		exit/b 1
	)
	REM ×Ó³ÌÐòÔË×÷¿ªÊ¼
...
exit/b
:Unicode22320
set Unicode_Result=µØ
exit/b
:UnicodeµØ
set Unicode_Result=22320
exit/b
:Unicode33922
set Unicode_Result=µÙ
exit/b
:UnicodeµÙ
set Unicode_Result=33922
exit/b
:Unicode31532
set Unicode_Result=µÚ
exit/b
:UnicodeµÚ
set Unicode_Result=31532
exit/b
:Unicode24093
set Unicode_Result=µÛ
exit/b
:UnicodeµÛ
set Unicode_Result=24093
exit/b
:Unicode24351
set Unicode_Result=µÜ
exit/b
:UnicodeµÜ
set Unicode_Result=24351
exit/b
:Unicode36882
set Unicode_Result=µÝ
exit/b
:UnicodeµÝ
set Unicode_Result=36882
exit/b
:Unicode32532
set Unicode_Result=µÞ
exit/b
:UnicodeµÞ
set Unicode_Result=32532
exit/b
:Unicode39072
set Unicode_Result=µß
exit/b
:Unicodeµß
...
exit/b
:Unicode36154
set Unicode_Result=ºØ
exit/b
:UnicodeºØ
set Unicode_Result=36154
exit/b
:Unicode22079
set Unicode_Result=ºÙ
exit/b
:UnicodeºÙ
set Unicode_Result=22079
exit/b
:Unicode40657
set Unicode_Result=ºÚ
exit/b
:UnicodeºÚ
set Unicode_Result=40657
exit/b
:Unicode30165
set Unicode_Result=ºÛ
exit/b
:UnicodeºÛ
set Unicode_Result=30165
exit/b
:Unicode24456
set Unicode_Result=ºÜ
exit/b
:UnicodeºÜ
set Unicode_Result=24456
exit/b
:Unicode29408
set Unicode_Result=ºÝ
exit/b
:UnicodeºÝ
set Unicode_Result=29408
exit/b
:Unicode24680
set Unicode_Result=ºÞ
exit/b
:UnicodeºÞ
set Unicode_Result=24680
exit/b
:Unicode21756
set Unicode_Result=ºß
exit/b
:Unicodeºß
...
exit/b
:Unicode38253
set Unicode_Result=ÀØ
exit/b
:UnicodeÀØ
set Unicode_Result=38253
exit/b
:Unicode34174
set Unicode_Result=ÀÙ
exit/b
:UnicodeÀÙ
set Unicode_Result=34174
exit/b
:Unicode30922
set Unicode_Result=ÀÚ
exit/b
:UnicodeÀÚ
set Unicode_Result=30922
exit/b
:Unicode32047
set Unicode_Result=ÀÛ
exit/b
:UnicodeÀÛ
set Unicode_Result=32047
exit/b
:Unicode20769
set Unicode_Result=ÀÜ
exit/b
:UnicodeÀÜ
set Unicode_Result=20769
exit/b
:Unicode22418
set Unicode_Result=ÀÝ
exit/b
:UnicodeÀÝ
set Unicode_Result=22418
exit/b
:Unicode25794
set Unicode_Result=ÀÞ
exit/b
:UnicodeÀÞ
set Unicode_Result=25794
exit/b
:Unicode32907
set Unicode_Result=Àß
exit/b
:UnicodeÀß
...
exit/b
:Unicode38678
set Unicode_Result=ÁØ
exit/b
:UnicodeÁØ
set Unicode_Result=38678
exit/b
:Unicode20020
set Unicode_Result=ÁÙ
exit/b
:UnicodeÁÙ
set Unicode_Result=20020
exit/b
:Unicode37051
set Unicode_Result=ÁÚ
exit/b
:UnicodeÁÚ
set Unicode_Result=37051
exit/b
:Unicode40158
set Unicode_Result=ÁÛ
exit/b
:UnicodeÁÛ
set Unicode_Result=40158
exit/b
:Unicode28107
set Unicode_Result=ÁÜ
exit/b
:UnicodeÁÜ
set Unicode_Result=28107
exit/b
:Unicode20955
set Unicode_Result=ÁÝ
exit/b
:UnicodeÁÝ
set Unicode_Result=20955
exit/b
:Unicode36161
set Unicode_Result=ÁÞ
exit/b
:UnicodeÁÞ
set Unicode_Result=36161
exit/b
:Unicode21533
set Unicode_Result=Áß
exit/b
:UnicodeÁß
...
exit/b
:Unicode20177
set Unicode_Result=ÂØ
exit/b
:UnicodeÂØ
set Unicode_Result=20177
exit/b
:Unicode27814
set Unicode_Result=ÂÙ
exit/b
:UnicodeÂÙ
set Unicode_Result=27814
exit/b
:Unicode32438
set Unicode_Result=ÂÚ
exit/b
:UnicodeÂÚ
set Unicode_Result=32438
exit/b
:Unicode35770
set Unicode_Result=ÂÛ
exit/b
:UnicodeÂÛ
set Unicode_Result=35770
exit/b
:Unicode33821
set Unicode_Result=ÂÜ
exit/b
:UnicodeÂÜ
set Unicode_Result=33821
exit/b
:Unicode34746
set Unicode_Result=ÂÝ
exit/b
:UnicodeÂÝ
set Unicode_Result=34746
exit/b
:Unicode32599
set Unicode_Result=ÂÞ
exit/b
:UnicodeÂÞ
set Unicode_Result=32599
exit/b
:Unicode36923
set Unicode_Result=Âß
exit/b
:UnicodeÂß
...
exit/b
:Unicode31192
set Unicode_Result=ÃØ
exit/b
:UnicodeÃØ
set Unicode_Result=31192
exit/b
:Unicode35269
set Unicode_Result=ÃÙ
exit/b
:UnicodeÃÙ
set Unicode_Result=35269
exit/b
:Unicode27852
set Unicode_Result=ÃÚ
exit/b
:UnicodeÃÚ
set Unicode_Result=27852
exit/b
:Unicode34588
set Unicode_Result=ÃÛ
exit/b
:UnicodeÃÛ
set Unicode_Result=34588
exit/b
:Unicode23494
set Unicode_Result=ÃÜ
exit/b
:UnicodeÃÜ
set Unicode_Result=23494
exit/b
:Unicode24130
set Unicode_Result=ÃÝ
exit/b
:UnicodeÃÝ
set Unicode_Result=24130
exit/b
:Unicode26825
set Unicode_Result=ÃÞ
exit/b
:UnicodeÃÞ
set Unicode_Result=26825
exit/b
:Unicode30496
set Unicode_Result=Ãß
exit/b
:UnicodeÃß
...
exit/b
:Unicode21602
set Unicode_Result=ÄØ
exit/b
:UnicodeÄØ
set Unicode_Result=21602
exit/b
:Unicode39297
set Unicode_Result=ÄÙ
exit/b
:UnicodeÄÙ
set Unicode_Result=39297
exit/b
:Unicode20869
set Unicode_Result=ÄÚ
exit/b
:UnicodeÄÚ
set Unicode_Result=20869
exit/b
:Unicode23273
set Unicode_Result=ÄÛ
exit/b
:UnicodeÄÛ
set Unicode_Result=23273
exit/b
:Unicode33021
set Unicode_Result=ÄÜ
exit/b
:UnicodeÄÜ
set Unicode_Result=33021
exit/b
:Unicode22958
set Unicode_Result=ÄÝ
exit/b
:UnicodeÄÝ
set Unicode_Result=22958
exit/b
:Unicode38675
set Unicode_Result=ÄÞ
exit/b
:UnicodeÄÞ
set Unicode_Result=38675
exit/b
:Unicode20522
set Unicode_Result=Äß
exit/b
:UnicodeÄß
...
exit/b
:Unicode21638
set Unicode_Result=ÅØ
exit/b
:UnicodeÅØ
set Unicode_Result=21638
exit/b
:Unicode21032
set Unicode_Result=ÅÙ
exit/b
:UnicodeÅÙ
set Unicode_Result=21032
exit/b
:Unicode28846
set Unicode_Result=ÅÚ
exit/b
:UnicodeÅÚ
set Unicode_Result=28846
exit/b
:Unicode34957
set Unicode_Result=ÅÛ
exit/b
:UnicodeÅÛ
set Unicode_Result=34957
exit/b
:Unicode36305
set Unicode_Result=ÅÜ
exit/b
:UnicodeÅÜ
set Unicode_Result=36305
exit/b
:Unicode27873
set Unicode_Result=ÅÝ
exit/b
:UnicodeÅÝ
set Unicode_Result=27873
exit/b
:Unicode21624
set Unicode_Result=ÅÞ
exit/b
:UnicodeÅÞ
set Unicode_Result=21624
exit/b
:Unicode32986
set Unicode_Result=Åß
exit/b
:UnicodeÅß
...
exit/b
:Unicode26333
set Unicode_Result=ÆØ
exit/b
:UnicodeÆØ
set Unicode_Result=26333
exit/b
:Unicode28689
set Unicode_Result=ÆÙ
exit/b
:UnicodeÆÙ
set Unicode_Result=28689
exit/b
:Unicode26399
set Unicode_Result=ÆÚ
exit/b
:UnicodeÆÚ
set Unicode_Result=26399
exit/b
:Unicode27450
set Unicode_Result=ÆÛ
exit/b
:UnicodeÆÛ
set Unicode_Result=27450
exit/b
:Unicode26646
set Unicode_Result=ÆÜ
exit/b
:UnicodeÆÜ
set Unicode_Result=26646
exit/b
:Unicode25114
set Unicode_Result=ÆÝ
exit/b
:UnicodeÆÝ
set Unicode_Result=25114
exit/b
:Unicode22971
set Unicode_Result=ÆÞ
exit/b
:UnicodeÆÞ
set Unicode_Result=22971
exit/b
:Unicode19971
set Unicode_Result=Æß
exit/b
:UnicodeÆß
...
exit/b
:Unicode31206
set Unicode_Result=ÇØ
exit/b
:UnicodeÇØ
set Unicode_Result=31206
exit/b
:Unicode29748
set Unicode_Result=ÇÙ
exit/b
:UnicodeÇÙ
set Unicode_Result=29748
exit/b
:Unicode21220
set Unicode_Result=ÇÚ
exit/b
:UnicodeÇÚ
set Unicode_Result=21220
exit/b
:Unicode33465
set Unicode_Result=ÇÛ
exit/b
:UnicodeÇÛ
set Unicode_Result=33465
exit/b
:Unicode25810
set Unicode_Result=ÇÜ
exit/b
:UnicodeÇÜ
set Unicode_Result=25810
exit/b
:Unicode31165
set Unicode_Result=ÇÝ
exit/b
:UnicodeÇÝ
set Unicode_Result=31165
exit/b
:Unicode23517
set Unicode_Result=ÇÞ
exit/b
:UnicodeÇÞ
set Unicode_Result=23517
exit/b
:Unicode27777
set Unicode_Result=Çß
exit/b
:UnicodeÇß
...
exit/b
:Unicode33993
set Unicode_Result=ÈØ
exit/b
:UnicodeÈØ
set Unicode_Result=33993
exit/b
:Unicode33635
set Unicode_Result=ÈÙ
exit/b
:UnicodeÈÙ
set Unicode_Result=33635
exit/b
:Unicode34701
set Unicode_Result=ÈÚ
exit/b
:UnicodeÈÚ
set Unicode_Result=34701
exit/b
:Unicode29076
set Unicode_Result=ÈÛ
exit/b
:UnicodeÈÛ
set Unicode_Result=29076
exit/b
:Unicode28342
set Unicode_Result=ÈÜ
exit/b
:UnicodeÈÜ
set Unicode_Result=28342
exit/b
:Unicode23481
set Unicode_Result=ÈÝ
exit/b
:UnicodeÈÝ
set Unicode_Result=23481
exit/b
:Unicode32466
set Unicode_Result=ÈÞ
exit/b
:UnicodeÈÞ
set Unicode_Result=32466
exit/b
:Unicode20887
set Unicode_Result=Èß
exit/b
:UnicodeÈß
...
exit/b
:Unicode38902
set Unicode_Result=ÉØ
exit/b
:UnicodeÉØ
set Unicode_Result=38902
exit/b
:Unicode23569
set Unicode_Result=ÉÙ
exit/b
:UnicodeÉÙ
set Unicode_Result=23569
exit/b
:Unicode21736
set Unicode_Result=ÉÚ
exit/b
:UnicodeÉÚ
set Unicode_Result=21736
exit/b
:Unicode37045
set Unicode_Result=ÉÛ
exit/b
:UnicodeÉÛ
set Unicode_Result=37045
exit/b
:Unicode32461
set Unicode_Result=ÉÜ
exit/b
:UnicodeÉÜ
set Unicode_Result=32461
exit/b
:Unicode22882
set Unicode_Result=ÉÝ
exit/b
:UnicodeÉÝ
set Unicode_Result=22882
exit/b
:Unicode36170
set Unicode_Result=ÉÞ
exit/b
:UnicodeÉÞ
set Unicode_Result=36170
exit/b
:Unicode34503
set Unicode_Result=Éß
exit/b
:UnicodeÉß
...
exit/b
:Unicode23432
set Unicode_Result=ÊØ
exit/b
:UnicodeÊØ
set Unicode_Result=23432
exit/b
:Unicode23551
set Unicode_Result=ÊÙ
exit/b
:UnicodeÊÙ
set Unicode_Result=23551
exit/b
:Unicode25480
set Unicode_Result=ÊÚ
exit/b
:UnicodeÊÚ
set Unicode_Result=25480
exit/b
:Unicode21806
set Unicode_Result=ÊÛ
exit/b
:UnicodeÊÛ
set Unicode_Result=21806
exit/b
:Unicode21463
set Unicode_Result=ÊÜ
exit/b
:UnicodeÊÜ
set Unicode_Result=21463
exit/b
:Unicode30246
set Unicode_Result=ÊÝ
exit/b
:UnicodeÊÝ
set Unicode_Result=30246
exit/b
:Unicode20861
set Unicode_Result=ÊÞ
exit/b
:UnicodeÊÞ
set Unicode_Result=20861
exit/b
:Unicode34092
set Unicode_Result=Êß
exit/b
:UnicodeÊß
...
exit/b
:Unicode32032
set Unicode_Result=ËØ
exit/b
:UnicodeËØ
set Unicode_Result=32032
exit/b
:Unicode36895
set Unicode_Result=ËÙ
exit/b
:UnicodeËÙ
set Unicode_Result=36895
exit/b
:Unicode31903
set Unicode_Result=ËÚ
exit/b
:UnicodeËÚ
set Unicode_Result=31903
exit/b
:Unicode20723
set Unicode_Result=ËÛ
exit/b
:UnicodeËÛ
set Unicode_Result=20723
exit/b
:Unicode22609
set Unicode_Result=ËÜ
exit/b
:UnicodeËÜ
set Unicode_Result=22609
exit/b
:Unicode28335
set Unicode_Result=ËÝ
exit/b
:UnicodeËÝ
set Unicode_Result=28335
exit/b
:Unicode23487
set Unicode_Result=ËÞ
exit/b
:UnicodeËÞ
set Unicode_Result=23487
exit/b
:Unicode35785
set Unicode_Result=Ëß
exit/b
:UnicodeËß
...
exit/b
:Unicode29305
set Unicode_Result=ÌØ
exit/b
:UnicodeÌØ
set Unicode_Result=29305
exit/b
:Unicode34276
set Unicode_Result=ÌÙ
exit/b
:UnicodeÌÙ
set Unicode_Result=34276
exit/b
:Unicode33150
set Unicode_Result=ÌÚ
exit/b
:UnicodeÌÚ
set Unicode_Result=33150
exit/b
:Unicode30140
set Unicode_Result=ÌÛ
exit/b
:UnicodeÌÛ
set Unicode_Result=30140
exit/b
:Unicode35466
set Unicode_Result=ÌÜ
exit/b
:UnicodeÌÜ
set Unicode_Result=35466
exit/b
:Unicode26799
set Unicode_Result=ÌÝ
exit/b
:UnicodeÌÝ
set Unicode_Result=26799
exit/b
:Unicode21076
set Unicode_Result=ÌÞ
exit/b
:UnicodeÌÞ
set Unicode_Result=21076
exit/b
:Unicode36386
set Unicode_Result=Ìß
exit/b
:UnicodeÌß
...
exit/b
:Unicode25299
set Unicode_Result=ÍØ
exit/b
:UnicodeÍØ
set Unicode_Result=25299
exit/b
:Unicode21822
set Unicode_Result=ÍÙ
exit/b
:UnicodeÍÙ
set Unicode_Result=21822
exit/b
:Unicode25366
set Unicode_Result=ÍÚ
exit/b
:UnicodeÍÚ
set Unicode_Result=25366
exit/b
:Unicode21703
set Unicode_Result=ÍÛ
exit/b
:UnicodeÍÛ
set Unicode_Result=21703
exit/b
:Unicode34521
set Unicode_Result=ÍÜ
exit/b
:UnicodeÍÜ
set Unicode_Result=34521
exit/b
:Unicode27964
set Unicode_Result=ÍÝ
exit/b
:UnicodeÍÝ
set Unicode_Result=27964
exit/b
:Unicode23043
set Unicode_Result=ÍÞ
exit/b
:UnicodeÍÞ
set Unicode_Result=23043
exit/b
:Unicode29926
set Unicode_Result=Íß
exit/b
:UnicodeÍß
...
exit/b
:Unicode21596
set Unicode_Result=ÎØ
exit/b
:UnicodeÎØ
set Unicode_Result=21596
exit/b
:Unicode38056
set Unicode_Result=ÎÙ
exit/b
:UnicodeÎÙ
set Unicode_Result=38056
exit/b
:Unicode20044
set Unicode_Result=ÎÚ
exit/b
:UnicodeÎÚ
set Unicode_Result=20044
exit/b
:Unicode27745
set Unicode_Result=ÎÛ
exit/b
:UnicodeÎÛ
set Unicode_Result=27745
exit/b
:Unicode35820
set Unicode_Result=ÎÜ
exit/b
:UnicodeÎÜ
set Unicode_Result=35820
exit/b
:Unicode23627
set Unicode_Result=ÎÝ
exit/b
:UnicodeÎÝ
set Unicode_Result=23627
exit/b
:Unicode26080
set Unicode_Result=ÎÞ
exit/b
:UnicodeÎÞ
set Unicode_Result=26080
exit/b
:Unicode33436
set Unicode_Result=Îß
exit/b
:UnicodeÎß
...
exit/b
:Unicode21439
set Unicode_Result=ÏØ
exit/b
:UnicodeÏØ
set Unicode_Result=21439
exit/b
:Unicode33146
set Unicode_Result=ÏÙ
exit/b
:UnicodeÏÙ
set Unicode_Result=33146
exit/b
:Unicode39301
set Unicode_Result=ÏÚ
exit/b
:UnicodeÏÚ
set Unicode_Result=39301
exit/b
:Unicode32673
set Unicode_Result=ÏÛ
exit/b
:UnicodeÏÛ
set Unicode_Result=32673
exit/b
:Unicode23466
set Unicode_Result=ÏÜ
exit/b
:UnicodeÏÜ
set Unicode_Result=23466
exit/b
:Unicode38519
set Unicode_Result=ÏÝ
exit/b
:UnicodeÏÝ
set Unicode_Result=38519
exit/b
:Unicode38480
set Unicode_Result=ÏÞ
exit/b
:UnicodeÏÞ
set Unicode_Result=38480
exit/b
:Unicode32447
set Unicode_Result=Ïß
exit/b
:UnicodeÏß
...
exit/b
:Unicode33016
set Unicode_Result=ÐØ
exit/b
:UnicodeÐØ
set Unicode_Result=33016
exit/b
:Unicode21256
set Unicode_Result=ÐÙ
exit/b
:UnicodeÐÙ
set Unicode_Result=21256
exit/b
:Unicode27769
set Unicode_Result=ÐÚ
exit/b
:UnicodeÐÚ
set Unicode_Result=27769
exit/b
:Unicode38596
set Unicode_Result=ÐÛ
exit/b
:UnicodeÐÛ
set Unicode_Result=38596
exit/b
:Unicode29066
set Unicode_Result=ÐÜ
exit/b
:UnicodeÐÜ
set Unicode_Result=29066
exit/b
:Unicode20241
set Unicode_Result=ÐÝ
exit/b
:UnicodeÐÝ
set Unicode_Result=20241
exit/b
:Unicode20462
set Unicode_Result=ÐÞ
exit/b
:UnicodeÐÞ
set Unicode_Result=20462
exit/b
:Unicode32670
set Unicode_Result=Ðß
exit/b
:UnicodeÐß
...
exit/b
:Unicode27839
set Unicode_Result=ÑØ
exit/b
:UnicodeÑØ
set Unicode_Result=27839
exit/b
:Unicode22852
set Unicode_Result=ÑÙ
exit/b
:UnicodeÑÙ
set Unicode_Result=22852
exit/b
:Unicode25513
set Unicode_Result=ÑÚ
exit/b
:UnicodeÑÚ
set Unicode_Result=25513
exit/b
:Unicode30524
set Unicode_Result=ÑÛ
exit/b
:UnicodeÑÛ
set Unicode_Result=30524
exit/b
:Unicode34893
set Unicode_Result=ÑÜ
exit/b
:UnicodeÑÜ
set Unicode_Result=34893
exit/b
:Unicode28436
set Unicode_Result=ÑÝ
exit/b
:UnicodeÑÝ
set Unicode_Result=28436
exit/b
:Unicode33395
set Unicode_Result=ÑÞ
exit/b
:UnicodeÑÞ
set Unicode_Result=33395
exit/b
:Unicode22576
set Unicode_Result=Ñß
exit/b
:UnicodeÑß
...
exit/b
:Unicode37009
set Unicode_Result=ÒØ
exit/b
:UnicodeÒØ
set Unicode_Result=37009
exit/b
:Unicode23673
set Unicode_Result=ÒÙ
exit/b
:UnicodeÒÙ
set Unicode_Result=23673
exit/b
:Unicode20159
set Unicode_Result=ÒÚ
exit/b
:UnicodeÒÚ
set Unicode_Result=20159
exit/b
:Unicode24441
set Unicode_Result=ÒÛ
exit/b
:UnicodeÒÛ
set Unicode_Result=24441
exit/b
:Unicode33222
set Unicode_Result=ÒÜ
exit/b
:UnicodeÒÜ
set Unicode_Result=33222
exit/b
:Unicode36920
set Unicode_Result=ÒÝ
exit/b
:UnicodeÒÝ
set Unicode_Result=36920
exit/b
:Unicode32900
set Unicode_Result=ÒÞ
exit/b
:UnicodeÒÞ
set Unicode_Result=32900
exit/b
:Unicode30123
set Unicode_Result=Òß
exit/b
:UnicodeÒß
...
exit/b
:Unicode36802
set Unicode_Result=ÓØ
exit/b
:UnicodeÓØ
set Unicode_Result=36802
exit/b
:Unicode28132
set Unicode_Result=ÓÙ
exit/b
:UnicodeÓÙ
set Unicode_Result=28132
exit/b
:Unicode20110
set Unicode_Result=ÓÚ
exit/b
:UnicodeÓÚ
set Unicode_Result=20110
exit/b
:Unicode30402
set Unicode_Result=ÓÛ
exit/b
:UnicodeÓÛ
set Unicode_Result=30402
exit/b
:Unicode27014
set Unicode_Result=ÓÜ
exit/b
:UnicodeÓÜ
set Unicode_Result=27014
exit/b
:Unicode34398
set Unicode_Result=ÓÝ
exit/b
:UnicodeÓÝ
set Unicode_Result=34398
exit/b
:Unicode24858
set Unicode_Result=ÓÞ
exit/b
:UnicodeÓÞ
set Unicode_Result=24858
exit/b
:Unicode33286
set Unicode_Result=Óß
exit/b
:UnicodeÓß
...
exit/b
:Unicode36733
set Unicode_Result=ÔØ
exit/b
:UnicodeÔØ
set Unicode_Result=36733
exit/b
:Unicode20877
set Unicode_Result=ÔÙ
exit/b
:UnicodeÔÙ
set Unicode_Result=20877
exit/b
:Unicode22312
set Unicode_Result=ÔÚ
exit/b
:UnicodeÔÚ
set Unicode_Result=22312
exit/b
:Unicode21681
set Unicode_Result=ÔÛ
exit/b
:UnicodeÔÛ
set Unicode_Result=21681
exit/b
:Unicode25874
set Unicode_Result=ÔÜ
exit/b
:UnicodeÔÜ
set Unicode_Result=25874
exit/b
:Unicode26242
set Unicode_Result=ÔÝ
exit/b
:UnicodeÔÝ
set Unicode_Result=26242
exit/b
:Unicode36190
set Unicode_Result=ÔÞ
exit/b
:UnicodeÔÞ
set Unicode_Result=36190
exit/b
:Unicode36163
set Unicode_Result=Ôß
exit/b
:UnicodeÔß
...
exit/b
:Unicode32903
set Unicode_Result=ÕØ
exit/b
:UnicodeÕØ
set Unicode_Result=32903
exit/b
:Unicode21484
set Unicode_Result=ÕÙ
exit/b
:UnicodeÕÙ
set Unicode_Result=21484
exit/b
:Unicode36974
set Unicode_Result=ÕÚ
exit/b
:UnicodeÕÚ
set Unicode_Result=36974
exit/b
:Unicode25240
set Unicode_Result=ÕÛ
exit/b
:UnicodeÕÛ
set Unicode_Result=25240
exit/b
:Unicode21746
set Unicode_Result=ÕÜ
exit/b
:UnicodeÕÜ
set Unicode_Result=21746
exit/b
:Unicode34544
set Unicode_Result=ÕÝ
exit/b
:UnicodeÕÝ
set Unicode_Result=34544
exit/b
:Unicode36761
set Unicode_Result=ÕÞ
exit/b
:UnicodeÕÞ
set Unicode_Result=36761
exit/b
:Unicode32773
set Unicode_Result=Õß
exit/b
:UnicodeÕß
...
exit/b
:Unicode37325
set Unicode_Result=ÖØ
exit/b
:UnicodeÖØ
set Unicode_Result=37325
exit/b
:Unicode20210
set Unicode_Result=ÖÙ
exit/b
:UnicodeÖÙ
set Unicode_Result=20210
exit/b
:Unicode20247
set Unicode_Result=ÖÚ
exit/b
:UnicodeÖÚ
set Unicode_Result=20247
exit/b
:Unicode33311
set Unicode_Result=ÖÛ
exit/b
:UnicodeÖÛ
set Unicode_Result=33311
exit/b
:Unicode21608
set Unicode_Result=ÖÜ
exit/b
:UnicodeÖÜ
set Unicode_Result=21608
exit/b
:Unicode24030
set Unicode_Result=ÖÝ
exit/b
:UnicodeÖÝ
set Unicode_Result=24030
exit/b
:Unicode27954
set Unicode_Result=ÖÞ
exit/b
:UnicodeÖÞ
set Unicode_Result=27954
exit/b
:Unicode35788
set Unicode_Result=Öß
exit/b
:UnicodeÖß
...
exit/b
:Unicode21006
set Unicode_Result=ØØ
exit/b
:UnicodeØØ
set Unicode_Result=21006
exit/b
:Unicode21037
set Unicode_Result=ØÙ
exit/b
:UnicodeØÙ
set Unicode_Result=21037
exit/b
:Unicode21043
set Unicode_Result=ØÚ
exit/b
:UnicodeØÚ
set Unicode_Result=21043
exit/b
:Unicode21055
set Unicode_Result=ØÛ
exit/b
:UnicodeØÛ
set Unicode_Result=21055
exit/b
:Unicode21056
set Unicode_Result=ØÜ
exit/b
:UnicodeØÜ
set Unicode_Result=21056
exit/b
:Unicode21068
set Unicode_Result=ØÝ
exit/b
:UnicodeØÝ
set Unicode_Result=21068
exit/b
:Unicode21086
set Unicode_Result=ØÞ
exit/b
:UnicodeØÞ
set Unicode_Result=21086
exit/b
:Unicode21089
set Unicode_Result=Øß
exit/b
:UnicodeØß
...
exit/b
:Unicode20743
set Unicode_Result=ÙØ
exit/b
:UnicodeÙØ
set Unicode_Result=20743
exit/b
:Unicode20747
set Unicode_Result=ÙÙ
exit/b
:UnicodeÙÙ
set Unicode_Result=20747
exit/b
:Unicode20189
set Unicode_Result=ÙÚ
exit/b
:UnicodeÙÚ
set Unicode_Result=20189
exit/b
:Unicode27709
set Unicode_Result=ÙÛ
exit/b
:UnicodeÙÛ
set Unicode_Result=27709
exit/b
:Unicode20312
set Unicode_Result=ÙÜ
exit/b
:UnicodeÙÜ
set Unicode_Result=20312
exit/b
:Unicode20325
set Unicode_Result=ÙÝ
exit/b
:UnicodeÙÝ
set Unicode_Result=20325
exit/b
:Unicode20430
set Unicode_Result=ÙÞ
exit/b
:UnicodeÙÞ
set Unicode_Result=20430
exit/b
:Unicode40864
set Unicode_Result=Ùß
exit/b
:UnicodeÙß
...
exit/b
:Unicode35882
set Unicode_Result=ÚØ
exit/b
:UnicodeÚØ
set Unicode_Result=35882
exit/b
:Unicode35883
set Unicode_Result=ÚÙ
exit/b
:UnicodeÚÙ
set Unicode_Result=35883
exit/b
:Unicode35886
set Unicode_Result=ÚÚ
exit/b
:UnicodeÚÚ
set Unicode_Result=35886
exit/b
:Unicode35887
set Unicode_Result=ÚÛ
exit/b
:UnicodeÚÛ
set Unicode_Result=35887
exit/b
:Unicode35890
set Unicode_Result=ÚÜ
exit/b
:UnicodeÚÜ
set Unicode_Result=35890
exit/b
:Unicode35891
set Unicode_Result=ÚÝ
exit/b
:UnicodeÚÝ
set Unicode_Result=35891
exit/b
:Unicode35893
set Unicode_Result=ÚÞ
exit/b
:UnicodeÚÞ
set Unicode_Result=35893
exit/b
:Unicode35894
set Unicode_Result=Úß
exit/b
:UnicodeÚß
...
exit/b
:Unicode22316
set Unicode_Result=ÛØ
exit/b
:UnicodeÛØ
set Unicode_Result=22316
exit/b
:Unicode22314
set Unicode_Result=ÛÙ
exit/b
:UnicodeÛÙ
set Unicode_Result=22314
exit/b
:Unicode22323
set Unicode_Result=ÛÚ
exit/b
:UnicodeÛÚ
set Unicode_Result=22323
exit/b
:Unicode22329
set Unicode_Result=ÛÛ
exit/b
:UnicodeÛÛ
set Unicode_Result=22329
exit/b
:Unicode22318
set Unicode_Result=ÛÜ
exit/b
:UnicodeÛÜ
set Unicode_Result=22318
exit/b
:Unicode22319
set Unicode_Result=ÛÝ
exit/b
:UnicodeÛÝ
set Unicode_Result=22319
exit/b
:Unicode22364
set Unicode_Result=ÛÞ
exit/b
:UnicodeÛÞ
set Unicode_Result=22364
exit/b
:Unicode22331
set Unicode_Result=Ûß
exit/b
:UnicodeÛß
...
exit/b
:Unicode33543
set Unicode_Result=ÜØ
exit/b
:UnicodeÜØ
set Unicode_Result=33543
exit/b
:Unicode33500
set Unicode_Result=ÜÙ
exit/b
:UnicodeÜÙ
set Unicode_Result=33500
exit/b
:Unicode33524
set Unicode_Result=ÜÚ
exit/b
:UnicodeÜÚ
set Unicode_Result=33524
exit/b
:Unicode33490
set Unicode_Result=ÜÛ
exit/b
:UnicodeÜÛ
set Unicode_Result=33490
exit/b
:Unicode33496
set Unicode_Result=ÜÜ
exit/b
:UnicodeÜÜ
set Unicode_Result=33496
exit/b
:Unicode33548
set Unicode_Result=ÜÝ
exit/b
:UnicodeÜÝ
set Unicode_Result=33548
exit/b
:Unicode33531
set Unicode_Result=ÜÞ
exit/b
:UnicodeÜÞ
set Unicode_Result=33531
exit/b
:Unicode33491
set Unicode_Result=Üß
exit/b
:UnicodeÜß
...
exit/b
:Unicode33882
set Unicode_Result=ÝØ
exit/b
:UnicodeÝØ
set Unicode_Result=33882
exit/b
:Unicode33881
set Unicode_Result=ÝÙ
exit/b
:UnicodeÝÙ
set Unicode_Result=33881
exit/b
:Unicode33907
set Unicode_Result=ÝÚ
exit/b
:UnicodeÝÚ
set Unicode_Result=33907
exit/b
:Unicode33927
set Unicode_Result=ÝÛ
exit/b
:UnicodeÝÛ
set Unicode_Result=33927
exit/b
:Unicode33928
set Unicode_Result=ÝÜ
exit/b
:UnicodeÝÜ
set Unicode_Result=33928
exit/b
:Unicode33914
set Unicode_Result=ÝÝ
exit/b
:UnicodeÝÝ
set Unicode_Result=33914
exit/b
:Unicode33929
set Unicode_Result=ÝÞ
exit/b
:UnicodeÝÞ
set Unicode_Result=33929
exit/b
:Unicode33912
set Unicode_Result=Ýß
exit/b
:UnicodeÝß
...
exit/b
:Unicode25378
set Unicode_Result=ÞØ
exit/b
:UnicodeÞØ
set Unicode_Result=25378
exit/b
:Unicode25334
set Unicode_Result=ÞÙ
exit/b
:UnicodeÞÙ
set Unicode_Result=25334
exit/b
:Unicode25401
set Unicode_Result=ÞÚ
exit/b
:UnicodeÞÚ
set Unicode_Result=25401
exit/b
:Unicode25419
set Unicode_Result=ÞÛ
exit/b
:UnicodeÞÛ
set Unicode_Result=25419
exit/b
:Unicode25411
set Unicode_Result=ÞÜ
exit/b
:UnicodeÞÜ
set Unicode_Result=25411
exit/b
:Unicode25517
set Unicode_Result=ÞÝ
exit/b
:UnicodeÞÝ
set Unicode_Result=25517
exit/b
:Unicode25590
set Unicode_Result=ÞÞ
exit/b
:UnicodeÞÞ
set Unicode_Result=25590
exit/b
:Unicode25457
set Unicode_Result=Þß
exit/b
:UnicodeÞß
...
exit/b
:Unicode21715
set Unicode_Result=ßØ
exit/b
:UnicodeßØ
set Unicode_Result=21715
exit/b
:Unicode21716
set Unicode_Result=ßÙ
exit/b
:UnicodeßÙ
set Unicode_Result=21716
exit/b
:Unicode21618
set Unicode_Result=ßÚ
exit/b
:UnicodeßÚ
set Unicode_Result=21618
exit/b
:Unicode21667
set Unicode_Result=ßÛ
exit/b
:UnicodeßÛ
set Unicode_Result=21667
exit/b
:Unicode21717
set Unicode_Result=ßÜ
exit/b
:UnicodeßÜ
set Unicode_Result=21717
exit/b
:Unicode21691
set Unicode_Result=ßÝ
exit/b
:UnicodeßÝ
set Unicode_Result=21691
exit/b
:Unicode21695
set Unicode_Result=ßÞ
exit/b
:UnicodeßÞ
set Unicode_Result=21695
exit/b
:Unicode21708
set Unicode_Result=ßß
exit/b
:Unicodeßß
